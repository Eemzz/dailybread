                        ...
                        LazyColumn(contentPadding = PaddingValues(16.dp)) {
                            ...
                            item() {
                                ...
                                Column(Modifier.fillMaxSize()) {
                                    Row(
                                        Modifier.fillMaxSize(), horizontalArrangement =
                                        Arrangement.Center
                                    ) {
                                ...
                                item.items.forEach { ingredient ->
                                    Column() {
                                        Row(
                                            Modifier.fillMaxSize(), verticalAlignment =
                                            CenterVertically
                                        ) {
                                            if (ingredient.name != "") {
                                                Text(
                        ...
                        Button(
                            onClick = {
                                ...
                                val newInventoryItem: InventoryItem =
                                    InventoryItem(NewCategoryTextState.value.text, ingList)
